...
import com.advait.s.emokylo.RateMeMaybeFragment.RMMFragInterface;
...
public class RateMeMaybe implements RMMFragInterface {
	...
	public void _handleNegativeChoice() {
		...
		email.putExtra(Intent.EXTRA_EMAIL, new String[]{"advaitofficial@saravade.in"});		  
		email.putExtra(Intent.EXTRA_SUBJECT, "I Have An Idea For Clock Mate!");
		email.putExtra(Intent.EXTRA_TEXT, "");
		email.setType("message/rfc822");
		mActivity.startActivity(Intent.createChooser(email, "Complete action:"));
	}
